...
const SneakersGridComponent = () => {
  return (
    <div >
      ...
      <Card>
        <Card.Img variant="top" src="https://imgnike-a.akamaihd.net/768x768/025339A1.jpg" className='rounded-3' />
        <Card.Body>
          <Card.Title>Card title</Card.Title>
          <Card.Text>
      ...
      <Card>
        <Card.Img variant="top" src="https://imgnike-a.akamaihd.net/360x360/0245043X.jpg" className='rounded-3' />
        <Card.Body>
          <Card.Title>Card title</Card.Title>
          <Card.Text>
            This is a wider card with supporting text below as a natural lead-in
...
export default SneakersGridComponent